...
export default async function ReportsHub() {
  ...
  const DATED = new Set([
    ...
    "payments", "refunds-credits", "purchases", "purchases-by-product", "purchases-by-supplier", "supplier-statement", "invoice-discrepancies", "po-receiving-invoice", "supplier-prices", "dv-register", "supplier-payments",
  ]);
