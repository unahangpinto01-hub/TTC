    ...
    <div className="max-w-2xl">
      ...
      <div className="card mb-4 space-y-3">
        <p className="text-sm text-gray-600">
          Upload an Excel file with columns: <code className="rounded bg-gray-100 px-1 text-xs">sku, name, parentItem, activeIngredient, category, cropTags, packSize, piecesPerCarton, packGrossWeightKg, unitCost, dealerPrice, cartonDealerPrice, srp, reorderPoint, supplier, openingStock</code>.
